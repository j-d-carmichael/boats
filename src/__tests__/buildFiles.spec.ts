...
describe('Check to ensure the files are generated with the correct file names:', () => {
  ...
  it('built builtOA2_std_1.0.1.yml', async () => {
    ...
    expect(infile.paths['/weather/id/{id}'].delete.tags[0]).toBe('weather')
    expect(infile.paths['/weather/id/{id}'].delete.summary).toBe('weather set to rain')
    expect(infile.paths['/weather/id/{id}'].delete.description).toBe('Reset awful sunny weather to excellent rainy weather')
    expect(infile.paths['/weather/id/{id}'].delete.operationId).toBe('v1WeatherIdDelete')
    expect(infile.paths['/weather/id/{id}'].delete['x-filename']).toBe('delete')
    expect(infile.paths['/weather/id/{id}'].delete.parameters[0].$ref).toBe('#/parameters/PathId')
    expect(infile.paths['/weather/id/{id}'].delete.parameters[1].$ref).toBe('#/parameters/QueryOffset')
    expect(infile.paths['/weather/id/{id}'].delete.parameters[2].$ref).toBe('#/parameters/QueryTextSearch')
    expect(infile.paths['/weather/id/{id}'].delete.parameters[3].in).toBe('query')
    expect(infile.paths['/weather/id/{id}'].delete.parameters[3].name).toBe('areYouSure')
    expect(infile.paths['/weather/id/{id}'].delete.parameters[3].required).toBe(true)
    expect(infile.paths['/weather/id/{id}'].delete.parameters[3].type).toBe('string')
    expect(infile.paths['/weather/id/{id}'].delete.parameters[4].in).toBe('query')
    expect(infile.paths['/weather/id/{id}'].delete.parameters[4].name).toBe('areYouSureSure')
    expect(infile.paths['/weather/id/{id}'].delete.parameters[4].required).toBe(true)
    expect(infile.paths['/weather/id/{id}'].delete.parameters[4].type).toBe('string')
    expect(infile.paths['/weather/id/{id}'].delete.responses[200].description).toBe('Deleted')
    expect(infile.paths['/weather/id/{id}'].delete.responses[404].description).toBe('Temp not found')
    ...
    expect(infile.definitions.StarWars.properties.empireName.type).toBe('string')
    expect(infile.definitions.StarWars.properties.rebellious.type).toBe('boolean')
    expect(infile.definitions.StarWars.properties.darthVader.type).toBe('boolean')
  ...
  it('built builtOA2_readonly_1.0.1.yml', async () => {
    const infile:any = jsYaml.safeLoad(fs.readFileSync('test-build/builtOA2_readonly/builtOA2_readonly_1.0.1.yml', 'utf8'))
    expect(infile.swagger).toBe('2.0')
    expect(infile.info.version).toBe('1.0.1')
    expect(infile.info.title).toBe('boats')
    expect(infile.info.description).toBe('A sample API')
  ...
  it('built builtOA2_no_version.yml', async () => {
    const infile:any = jsYaml.safeLoad(fs.readFileSync('test-build/builtOA2_no_version/builtOA2_no_version.yml', 'utf8'))
    expect(infile.swagger).toBe('2.0')
    expect(infile.info.version).toBe('1.0.1')
    expect(infile.info.title).toBe('boats')
    expect(infile.info.description).toBe('A sample API')
  ...
  it('built test-build/builtOA2_inject/api_1.0.1.yml', async () => {
    ...
    expect(infile.paths['/weather/id/{id}'].delete.responses[200].description).toBe('Deleted')
    expect(infile.paths['/weather/id/{id}'].delete.responses[404].description).toBe('Temp not found')
    expect(infile.paths['/weather/id/{id}'].delete['x-autoTag']).toBe('V1')
    expect(infile.paths['/weather/id/{id}'].delete['x-fileName']).toBe('delete')
    expect(infile.paths['/weather/id/{id}'].delete['x-uniqueOpId']).toBe('v1WeatherIdDelete')
    expect(infile.paths['/weather/id/{id}'].delete['x-template-permission']).toBe('deleteV1WeatherIdDelete')
    expect(infile.paths['/weather/id/{id}'].delete['x-template-description']).toBe('v1WeatherIdDelete')
    expect(infile.paths['/weather/id/{id}'].delete['x-template-resolution'].a.$ref).toBe('#/parameters/HeaderSearchId')
    expect(infile.paths['/weather/id/{id}'].delete['x-template-resolution'].b.$ref).toBe('#/parameters/HeaderSearchId')
    expect(infile.paths['/weather/id/{id}'].delete['x-template-resolution'].c.$ref).toBe('#/parameters/HeaderSearchId')
    expect(infile.paths['/weather/id/{id}'].delete['x-json-content-test']).toBe('v1WeatherIdDelete')
    expect(infile.paths['/weather/id/{id}'].put.tags[0]).toBe('weather')
    expect(infile.paths['/weather/id/{id}'].put.summary).toBe('weather data')
    expect(infile.paths['/weather/id/{id}'].put.description).toBe('Create a new weather record.')
    expect(infile.paths['/weather/id/{id}'].put.operationId).toBe('v1WeatherIdPut')
