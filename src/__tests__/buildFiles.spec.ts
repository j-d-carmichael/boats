...
describe('Check to ensure the files are generated with the correct file names:', () => {
  const paths = [
    ...
    ['test-build/builtOA2_std/builtOA2_std_1.0.1.yml', 'ba452acbff0251d85105c8dd0fe793cd'],
    ['test-build/builtOA2_readonly/builtOA2_readonly_1.0.1.yml', 'f5ea75fe701702d3c6fb183cd98b5689'],
    ['test-build/builtOA2_no_version/builtOA2_no_version.yml', 'ba452acbff0251d85105c8dd0fe793cd'],
    ...
    ['test-build/builtOA2_inject/api_1.0.1.yml', '926f38b802c9f0ffa0ce2e16e9f7b22d'],
  ]
